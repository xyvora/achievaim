  ...
  {#each goals as goal}
    <li class="px-4 py-2 mb-2 bg-white rounded shadow-md">
      ...
      <form class="mt-4" on:submit={(e) => handleUpdate(e, goal)}>
        ...
        <button
          type="submit"
          class="px-4 py-2 mt-4 font-semibold text-white bg-blue-500 rounded hover:bg-blue-600"
          >Update Goal</button
        >
      </form>
    </li>
