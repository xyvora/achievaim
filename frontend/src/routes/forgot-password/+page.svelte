<script lang="ts">
  ...
  function handleSubmit() {
    ...
    console.log('Answer to the security question: ', securityAnswer);
  }
</script>
  ...
  >
    <figure>
      <figcaption class="p-4 card-body flex flex-col space-y-8">
        ...
        <p>Enter your email and the answer to your security question below</p>
        <div class="flex flex-wrap -mx-3 mb-8">
          <div class="w-full px-3 mb-4 sm:mb-6">
            <label for="email" class="block uppercase tracking-wide text-xs font-bold mb-2 sm:mb-3"
              >Your email</label
            >
            <input
              type="email"
              ...
              class="appearance-none block w-full bg-grey-lighter text-grey-darker border rounded py-3 px-4 mb-2 sm:mb-3 leading-tight focus:outline-none focus:bg-white"
              required
            />
          </div>
          <div class="w-full px-3 mb-4 sm:mb-6">
            <label
              ...
              >If you could have any superpower, what would it be?</label
            >
            <input
              type="text"
