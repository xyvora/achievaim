<script lang="ts">
  ...
  // file because TypeScript is bad and fails checks without it.
  ...
  let goal = $goals!.find((x: GoalOutput) => x.id === data.goalId);
  ...
  const toggleAll = () => {
    selectAll = !selectAll;
    if (goal != undefined && goal.days_of_week) {
...
<div class="page-fade-in">
  {#if goal != undefined}
    <div
      class="container z-10 px-4 pt-5 mx-auto mb-4 shadow-lg rounded-xl md:max-w-xl lg:max-w-3xl"
    >
          ...
          <div class="dropdown dropdown-right">
            ...
            <div class="card compact dropdown-content z-[1] bg-base-100 rounded-box w-64">
              ...
              <div class="text-left normal-case card-body text-primary">
                ...
                <p>
                  ← Toggle Left to Unlock and press Generate again to give you another suggestion
                  for that specific SMART detail
                </p>
              </div>
            </div>
          </div>
                    ...
                    <label for="selectAll" class="flex items-center cursor-pointer label">
                      ...
                      >
                        <div class="dropdown dropdown-end">
                          <button
                            tabindex="0"
                            class="m-3 btn btn-circle btn-ghost btn-xs text-info"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
          ...
          <figure>
            <figcaption class="flex flex-row items-center p-4 card-body">
              ...
              <div class="flex items-center flex-grow">
                ...
                />
                <div
                  class="justify-end w-full mt-2 dropdown dropdown-end md:ml-2 md:mt-0 md:w-auto"
                >
